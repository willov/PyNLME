...
# Linux (x86_64):
uv add https://github.com/willov/PyNLME/releases/download/v0.2.1/pynlme-0.2.1-cp311-abi3-linux_x86_64.whl

# Windows (x86_64):
uv add https://github.com/willov/PyNLME/releases/download/v0.2.1/pynlme-0.2.1-cp311-abi3-win_amd64.whl

# macOS (Intel):
uv add https://github.com/willov/PyNLME/releases/download/v0.2.1/pynlme-0.2.1-cp311-abi3-macosx_10_12_x86_64.whl

# macOS (Apple Silicon):
uv add https://github.com/willov/PyNLME/releases/download/v0.2.1/pynlme-0.2.1-cp311-abi3-macosx_11_0_arm64.whl

# Or using pip instead of uv:
pip install https://github.com/willov/PyNLME/releases/download/v0.2.1/pynlme-0.2.1-cp311-abi3-linux_x86_64.whl
